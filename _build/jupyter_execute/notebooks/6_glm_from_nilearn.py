...
def get_info_from_bids(
    ...
    models, models_run_imgs, models_events, models_confounds =     first_level_from_bids(dataset_path = data_dir, task_label = task_label, space_label = space_label,
...
get_ipython().system('ls ../outputs/6_glm')
